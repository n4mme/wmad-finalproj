 ...
 * 2. Import this in your app or run it from the browser console
 * 3. Call: createCaviteListings('YOUR_HOST_USER_ID')
 */
...
/**
 * Create 2 complete home listings in Cavite
 */
export const createCaviteListings = async (hostId) => {
    if (!hostId) {
...
export default createCaviteListings;
